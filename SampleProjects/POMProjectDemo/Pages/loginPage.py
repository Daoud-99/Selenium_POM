...
class LoginPage():
    ...
    def __init__(self, driver):
        ...
        self.login_button_class = "//button[contains(@class, 'orangehrm-login-button')]"
    ...
    def click_login(self):
        ...
        self.driver.find_element(By.XPATH, "//button[contains(@class, 'orangehrm-login-button')]").click()
